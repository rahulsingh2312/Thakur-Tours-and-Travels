...
function Navbar() {
  ...
  return (
    <nav className="relative text-15xl px-4 py-4 flex justify-between items-center bg-white">
      {/* eslint-disable jsx-a11y/anchor-is-valid */}
      <span>
      <a className="text-15xl font-bold leading-none" href="#">
      <img className="w-20" src={Logo1} alt="Logo" />
       </a>
           </span>
           <span className='ml-4 text-1xl'>Thakur tours & travels</span>
      ...
      <ul className={`hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6 ${isMenuOpen ? '' : 'hidden'}`}>
       {/* eslint-disable jsx-a11y/anchor-is-valid */}
        ...
        <li><a className="text-2xl text-gray-400 hover:text-gray-500" href="#">Home</a></li>
      {/* eslint-disable jsx-a11y/anchor-is-valid */}
        <li><a className="text-2xl text-blue-600 font-bold" href="#">About Us</a></li>
       {/* eslint-disable jsx-a11y/anchor-is-valid */}
        <li><a className="text-2xl text-gray-400 hover:text-gray-500" href="#">Services</a></li>
       {/* eslint-disable jsx-a11y/anchor-is-valid */}
        <li><a className="text-2xl text-gray-400 hover:text-gray-500" href="#">Pricing</a></li>
        {/* eslint-disable jsx-a11y/anchor-is-valid */}
        <li><a className="text-2xl text-gray-400 hover:text-gray-500" href="#">Contact</a></li>
      </ul>
      {/* eslint-disable jsx-a11y/anchor-is-valid */}
      ...
      <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-7 bg-white border-r overflow-y-auto">
        ...
        <div>
          ...
          <ul>
            <li className="mb-1">
              {/* eslint-disable jsx-a11y/anchor-is-valid */}
              <a className="block p-4 text-3xl font-semibold text-gray-470 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Home</a>
            </li>
            <li className="mb-1">
              {/* eslint-disable jsx-a11y/anchor-is-valid */}
              <a className="block p-4 text-3xl font-semibold text-gray-470 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">About Us</a>
            </li>
            <li className="mb-1">
              {/* eslint-disable jsx-a11y/anchor-is-valid */}
              <a className="block p-4 text-3xl font-semibold text-gray-470 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Services</a>
            </li>
            <li className="mb-1">
              {/* eslint-disable jsx-a11y/anchor-is-valid */}
              <a className="block p-4 text-3xl font-semibold text-gray-470 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">Pricing</a>
            </li>
            <li className="mb-1">
              {/* eslint-disable jsx-a11y/anchor-is-valid */}
